...
class MockApiRepositoryImpl : IApiRepository {
    ...
    fun getTacks(context: Context) = mutableListOf(
            ...
            Task(
                    ...
                    "",
                    null,
                    DateTime(2018, 1, 24, 22, 55),
                    DateTime(2018, 1, 27, 23, 55),
                    mutableListOf<User>(User(55, "", "", Location(""), ContextCompat.getColor(context, R.color.user3)),
                            User(55, "", "", Location(""), ContextCompat.getColor(context, R.color.user1))),
                    ArrayList<ChecklistItem>()
            ),
            Task(
                    3,
                    ...
                    "",
                    null,
                    DateTime(2018, 1, 24, 19, 55),
                    DateTime(2018, 1, 28, 21, 55),
